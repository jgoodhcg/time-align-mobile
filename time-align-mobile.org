...
**** Touch action changes
     ...
     - [ ] FAB state in app-db
     - [ ] FAB closes on drawer opening
     - [ ] Option for adding element exists in FAB
     - [ ] Adding element FAB option displays snack bar notifying user to touch anywhere
     - [ ] Dismissing snackbar cancels adding
**** Edit indicator
     - [ ] Remove all borders
