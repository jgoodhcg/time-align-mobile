...
*** TODO Minor fixes 
    ...
    - [ ] Tapping on templates doesn't select
    - [ ] Buttons in bottom sheet don't respond quickly
      - Probably need to turn of scroll listeners
        - Did the header component not have those?
    - [ ] Colors are wonky
    - [ ] Remove button borders
    - [ ] Changing bucket, saving, and attempting to close the bottom sheet crashes the app
