...
**** Misc along the way
     ...
     - [ ] Icons on Day FAB
     - [ ] Play selects period and jumps to
     - [ ] Drawer does not user surface comp and background is theme background
       
*** TODO Add google analytics to handlers
    :PROPERTIES:
...
**** Notes 
    ...
    *Do not commit GA key*
    ...
    https://analytics.google.com/analytics/web/#/a74205906p218292658/admin/streams/table
...
- Use fully qualified keywords for handler registrations so that [[https://github.com/oliyh/re-jump.el][this]] jump to library can be utilized
