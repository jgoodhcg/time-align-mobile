...
* DOSUB Time Align Mobile
  :LOGBOOK:
  CLOCK: [2020-03-08 Sun 12:00]--[2020-03-08 Sun 21:43] =>  9:43
...
*** TODO Publish to beta track
    ...
    :END:
**** DONE Make sure the app runs on the ios simulator 
     CLOSED: [2020-03-07 Sat 18:38]
     :LOGBOOK:
     CLOCK: [2020-03-07 Sat 17:55]--[2020-03-07 Sat 18:38] =>  0:43
     CLOCK: [2020-03-02 Mon 20:28]--[2020-03-02 Mon 20:55] =>  0:27
     :END:
     - [X] Set up simulator on macbook
       - [X] Install brew
       - [X] Install xcode
       - [X] Create simulator instance
         - [X] =Xcode > open developer tool > simulator=
       - [X] Get client app on simulator
         - [X] Install node =brew install node=
         - [X] Use expo-cli to install expo-client on simulator =expo client:install:ios=
           - new link https://docs.expo.io/versions/latest/workflow/ios-simulator/#how-do-i-force-an-update-to
           - old link https://docs.expo.io/versions/v34.0.0/introduction/installation/#ios-simulator manually
     - [X] Open app (running on main laptop) in the expo client running on the simulator
       - [X] Lightly regression test
**** Decide on release tag convention 
**** Upload to test flight in app store
     :LOGBOOK:
     CLOCK: [2020-03-02 Mon 20:59]--[2020-03-02 Mon 21:05] =>  0:06
     :END:
     - [ ] Set up an apple developer account
       - [ ] Set up two factor auth on apple id https://support.apple.com/en-us/HT204915
       - [ ] Enroll as an individual https://developer.apple.com/programs/enroll/
...
**** Upload to testing track play store  
     :LOGBOOK:
     CLOCK: [2020-03-08 Sun 19:14]--[2020-03-08 Sun 20:24] =>  1:10
     CLOCK: [2020-03-08 Sun 18:51]--[2020-03-08 Sun 19:08] =>  0:17
     CLOCK: [2020-03-08 Sun 16:17]--[2020-03-08 Sun 17:19] =>  1:02
     CLOCK: [2020-01-13 Mon 19:00]--[2020-01-13 Mon 19:23] =>  0:23
     :END:
     - [X] Set up play store account
     - [X] Set up a play store project and submit for review
       ...
       - [X] Screenshots
       - [X] Build
         - [X] release channel ~prd~
         - [X] Version in play console ~release-prd-build-1-expo-35-version-62~
       - [X] All the content, rating, and misc stuff
       - [X] Rollout release to production
*** BLOCKED Supporting tasks for beta launch
**** Rebrand to time sink ???
     - [ ] Do a google adds test
       - [ ] Make a simple add that can be run with "time sink" and "time align" and "Purysho"
     - [ ] Buy domain
...
*** TODO Minor fixes [15/31]
    :LOGBOOK:
    CLOCK: [2020-03-08 Sun 21:53]--[2020-03-08 Sun 21:53] =>  0:00
    CLOCK: [2020-03-08 Sun 20:56]--[2020-03-08 Sun 21:53] =>  0:57
    CLOCK: [2020-03-08 Sun 19:08]--[2020-03-08 Sun 19:09] =>  0:01
    CLOCK: [2020-03-08 Sun 12:46]--[2020-03-08 Sun 12:58] =>  0:12
    CLOCK: [2020-02-22 Sat 13:58]--[2020-02-22 Sat 14:00] =>  0:02
    ...
    - [X] Remove top bar button outline
    ...
    - [X] Enable spec validation on app-db
    - [ ] Make modal background color lighter
    - [ ] Zoom buttons should side affect to scroll to now or selected element
    - [ ] Calculate scores on day selection
    - [ ] Quickly selecting and deselecting a period causes the app to crash
    - [ ] Period form should reload when opening the app
    - [X] Periods do not display correctly on daylight savings time change days (the y positioning is all based on unix time stamp)
    - [ ] Distinguish between release channels in amplitude events
    - [ ] Import should refresh version
    - [X] Fix periods not displaying
    - [ ] Use moment ~isSame~ for ~same-day?~
    - [ ] Fix long press being an hour off (DST issue)
     
*** TODO Make a better report
    :PROPERTIES:
    :ID:       4024a25a-895f-47a9-9bf9-1bb4d61e5a2a
    :END:
**** DONE Better scoring algorithm
     CLOSED: [2020-02-22 Sat 13:25]
     :LOGBOOK:
...
***** Did the things happen *when* you wanted
      ...
      :END:
      :LOGBOOK:
      CLOCK: [2020-02-16 Sun 13:21]--[2020-02-16 Sun 14:19] =>  0:58
      CLOCK: [2020-02-16 Sun 12:53]--[2020-02-16 Sun 13:07] =>  0:14
      CLOCK: [2020-02-16 Sun 11:18]--[2020-02-16 Sun 11:59] =>  0:41
      ...
      - [X] Calculate the total (discounting overlapping) time for the actual periods
        - Discount overlapping time with [[./doc-images/comparing-planned-actual.png][this method]]
        - [X] Merge overlapping
        - [X] Bound start/stop of each actual by planned
      - [X] Get a ratio (relative difference?) of overlap to planned total as a score
      - [X] Accumulate the scores into one day score
***** Did you track the *amount* you should have? (whole day)
      :LOGBOOK:
      CLOCK: [2020-02-16 Sun 14:29]--[2020-02-16 Sun 15:29] =>  1:00
      :END:
      - [X] Calculate Total time planned per day
      - [X] Get the ratio (relative difference?) of planed time to total time in a day
      - [X] Calculate tracked (~:actual~) time in a day
      - [X] Get the ratio (relative difference?) of tracked  time to total time in a day
      - [X] Average the ratios
***** Define a total day score 
      :LOGBOOK:
      CLOCK: [2020-02-22 Sat 12:31]--[2020-02-22 Sat 13:21] =>  0:50
      CLOCK: [2020-02-17 Mon 18:40]--[2020-02-17 Mon 18:42] =>  0:02
      :END:
      - [X] The scores will probably all be relative differences, just average them together
**** DONE Use contribution chart
     CLOSED: [2020-02-22 Sat 13:55]
     :PROPERTIES:
     :ID:       87c346fa-7e83-4681-b73c-28274e54eef9
     :END:
     :LOGBOOK:
     CLOCK: [2020-02-22 Sat 13:25]--[2020-02-22 Sat 13:54] =>  0:29
     :END:
     - [X] Set up scoring algorithm in handler
     - [X] Wire it up to the subscription 
     - [X] Tweak as necessary to render the graph in a satisfying way
**** Have a breakdown for selected day 
     :LOGBOOK:
     CLOCK: [2020-03-01 Sun 16:37]--[2020-03-01 Sun 18:16] =>  1:39
     CLOCK: [2020-02-22 Sat 17:39]--[2020-02-22 Sat 17:42] =>  0:03
     :END:
