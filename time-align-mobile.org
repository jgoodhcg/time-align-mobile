...
***** TODO Figure out some more options
      :LOGBOOK:
...
****** TODO Expo/ReactNative profiling
...
******* Problem 2 ( tightly coupled state )
        :LOGBOOK:
        CLOCK: [2019-09-05 Thu 18:51]--[2019-09-05 Thu 19:18] =>  0:27
        :END:
- [X] Simplify refs as much as possible
- [ ] Push element subscribe to deepest component
- [ ] Separate planned and actual into two subscriptions
- [ ] Push selected element to deepest component
