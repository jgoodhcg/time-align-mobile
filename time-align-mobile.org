...
- [ ] Bottom sheet has play from option (scope creep)
  - [X] Starts a playing period
  - [ ] Stops when in play
- [-] Bottom sheet has select next/prev (scope creep)
  - [X] Works on day_planning screen
  - [ ] Works on pattern_planning screen
- [ ] Bottom sheet has drawer up indicator (scope creep)
**** TODO Enable persistence
**** TODO Stress test persistence
**** TODO Button either moves with drawer slide or disappears
