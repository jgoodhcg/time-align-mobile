...
*** TODO Minor fixes 
    ...
    - [ ] Play button from bottom sheet should also select the period it starts playing
    ...
    - [ ] When opening the app after selecting a period the bottom sheet isn't open and only opening the menu will deselect the period (fix might be to deselect on app init?)
    - [ ] Change day background to be darker
    - [ ] Change top bar and bottom sheet to be lighter
    - [ ] Add day score to contribution chart (pressing goes to reports)
    - [ ] Move drawer state to component (for performance)
...
**** Rebrand to time sink ???
     - [ ] Buy domain
     - [ ] +Change app package name+ Verify it is already done
     - [ ] Change repo name
**** Other
     - [ ] Publish static site
     - [ ] Add intro guide
...
** DOSUB Eventually [0/26]
   :PROPERTIES:
   :ID:       0eb2b451-f3bc-4609-81b6-37c69e74efe6
   :END:
*** TODO Update date picker component 
