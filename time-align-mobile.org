...
- [ ] Style transform buttons
- [ ] Make edit selection detectable
- [ ] Make all of day display visible while edit menu is up
- [X] Collapse bottom sheet on delete period
- [ ] Create safe fn for bottom sheet collapse
- [X] Add the edit form
- [X] Fix delete actions on elements
**** TODO Add FAB
**** TODO Add long press on screen to add period
