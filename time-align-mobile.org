...
** DOSUB Release to strangers
     ...
     |---------------------------------------------------------------------------------+--------------------------------+-------+------|
     | "[[Fix delete pattern button]]"                                                     |                           20.0 |    20 |    1 |
     | "[[Change snap points for bottom sheet]]"                                           |                            3.0 |     3 |    1 |
     | "[[Add handlers tests]]"                                                            |                            2.6 |    13 |    5 |
     | "[[Add subscriptions tests]]"                                                       |                            2.6 |    13 |    5 |
...
*** TODO Change snap points for bottom sheet
    :PROPERTIES:
    :VALUE:    3
    :WORK:     1
    :END:
    - [ ] Drag indicator is smaller
    - [ ] First snap position on selection shows all buttons
