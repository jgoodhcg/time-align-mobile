...
******* TODO Refactor app-db to use hash map for buckets and periods collection
...
******** TODO Fix runtime errors attempting to add new buckets end periods
         :LOGBOOK:
         CLOCK: [2019-09-08 Sun 12:50]
         ...
         :END:
- [X] Get to buckets page
- [X] Get bucket form load working
- [X] Get changes sub working for bucket form
- [X] Get save bucket changes handler working
- [x] Get loading period form working
- [ ] Get saving period form working
...
****** TODO Circumnavigate reframe events
       :LOGBOOK:
