...
*** TODO New day design
    ...
    :END:
**** Top bar with scroll view below
     :LOGBOOK:
     CLOCK: [2019-08-10 Sat 13:12]--[2019-08-10 Sat 13:14] =>  0:02
     :END:
- [ ] Get to a clean commit
- [ ] Blow away everything in day-screen ns and the day-comp ns
- [ ] Set up a day-comp ns with a placeholder
- [ ] Get code to compile and show placeholder for pattern-planning and day screens
- [ ] Add a top bar section
- [ ] Add a scroll view below it
