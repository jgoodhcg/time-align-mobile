...
- [-] Implement gesture handler experience on calendar page
  ...
  - [ ] (drag) Add pan gesture handler that locks out on no selection and waits for pinch
  - [X] (zoom) Add pinch gesture
  - [ ] (bottom sheet pop up selection) Add tap handler that wraps element and waits on long press
  - [ ] (movement selection) Add long press wrapping element directly
