...
**** Make sure the app runs on the ios simulator 
     ...
     - [ ] Set up simulator on macbook
       - [X] +Install brew+
         - Didn't need this one since I'm not actually running the project on the mac
       - [ ] Install xcode
       - [ ] Create simulator instance
       - [ ] Get client app on simulator https://docs.expo.io/versions/v34.0.0/introduction/installation/#ios-simulator manually
     - [ ] Open app (running on main laptop) in the expo client running on the simulator
