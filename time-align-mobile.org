...
**** Bottom sheet
     ...
     - [X] Save button top right and Filled
     - [X] Play button flat to the left of save
     ...
     - [ ] Bottom buttons only include edit (flat) and delete (flat)
     - [ ] Spacer size adjusts accordingly to bottom sheet position
*** TODO Use scrollTo 
    :PROPERTIES:
    :VALUE:    5
    :WORK:     2
