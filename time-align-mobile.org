...
**** TODO Bug fixes 
     ...
     - [ ] Now indicator not exactly in the right spot
     - [ ] Select playing in selection menu
     - [ ] Top bar date button needs to be contained on today and outlined otherwise
     - [ ] Long pressing on edit templates on pattern form broken
