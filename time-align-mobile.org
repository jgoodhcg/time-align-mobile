...
**** Touch action changes
     ...
     - [ ] Fab-roup closes on drawer opening
     - [ ] Option for adding element exists in fab-group
     - [ ] Adding element fab-group option displays banner notifying user to touch anywhere
     - [ ] Dismissing banner cancels adding
**** Edit indicator
     - [ ] Remove all borders
