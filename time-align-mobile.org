...
*** DONE Use scrollTo 
    ...
    :END:
    :LOGBOOK:
    CLOCK: [2019-11-23 Sat 14:01]--[2019-11-23 Sat 15:01] =>  1:00
    CLOCK: [2019-11-23 Sat 11:37]--[2019-11-23 Sat 12:39] =>  1:02
    CLOCK: [2019-11-23 Sat 10:42]--[2019-11-23 Sat 11:26] =>  0:44
    ...
    - [-] +Scrolls when selecting an element using options from period-form+
      - This was too hard to do. I kept running into the problem of needing to duplicate too much of a subscriber in a handler to make it a side effect.
    - [X] Option to jump to selected in bottom sheet
    - [-] +Scrolls to now on day re-render+
      - This is going to be too annoying. Let the user handle it.
    - [X] Scroll to now option in top bar
