...
**** DONE Figure out why bottom-sheet-ref doesn't work when released
     CLOSED: [2019-09-17 Tue 22:02]
     :LOGBOOK:
     CLOCK: [2019-09-17 Tue 21:01]--[2019-09-17 Tue 22:02] =>  1:01
     :END:
...
**** TODO Add FAB
     ...
     :END:
- [ ] Remove play from button on FAB
- [ ] Get FAB to render
- [ ] Only render fab when no selections
- [ ] Add /play from/ button to bottom sheet (only on periods)
